...
psql "postgresql://$confd_db_username:$confd_db_password@$confd_db_host:$confd_db_port/nestbox-confd" -c "INSERT INTO confd_reseller values ('$NESTBOX_TENANT', 'admin-reseller', now() at time zone 'utc');"
